...
async function rename(req: NextRequest, gridId: string) {
  requireDbConfigured();
...
// 方式違いでも落とさない
export async function POST(req: NextRequest, ctx: any) { return PATCH(req, ctx); }
export async function PUT(req: NextRequest, ctx: any) { return PATCH(req, ctx); }
